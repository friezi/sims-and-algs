 ...
 *
 */
public class LinearPointInterpolater3Dold extends APointInterpolater3Dold {
	...
	public LinearPointInterpolater3Dold(Point3D p1, Point3D p2, boolean avoidEmptyMoiree) {
		super();
		this.p1 = p1;
		this.p2 = p2;
