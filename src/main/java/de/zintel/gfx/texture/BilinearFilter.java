...
public class BilinearFilter extends AFilteredTexture {
	...
	//
	// if (ix == getTexture().getWidth() - 1 && iy == getTexture().getHeight() -
	// 1) {
	...
	//
	// return new Color(interpolateColor(ul.getRed(), dl.getRed(), dy),
	// interpolateColor(ul.getGreen(), dl.getGreen(), dy),
	...
	//
	// return new Color(interpolateColor(ul.getRed(), ur.getRed(), dx),
	// interpolateColor(ul.getGreen(), ur.getGreen(), dx),
	...
	//
	// return new Color(interpolateColor(ul.getRed(), ur.getRed(), dl.getRed(),
	// dr.getRed(), dx, dy),
	// interpolateColor(ul.getGreen(), ur.getGreen(), dl.getGreen(),
	// dr.getGreen(), dx, dy),
	// interpolateColor(ul.getBlue(), ur.getBlue(), dl.getBlue(), dr.getBlue(),
	// dx, dy));
	//
	// }
	// }
	...
	public Color getColor(double x, double y) {
		...
		final VectorND vectorColor = getTexture().interpolateLinear(new Vector2D(Arrays.asList(x, y)), colorVectorFactory);
	...
	// }
	//
	// private int interpolateColor(double ul, double ur, double dl, double dr,
	// double dx, double dy) {
	// final double dualdx = 1 - dx;
	// final double dualdy = 1 - dy;
	// return (int) (dualdx * dualdy * ul + dualdy * dx * ur + dualdx * dy * dl
	// + dx * dy * dr);
	// }
